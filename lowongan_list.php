                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.php" style="font-weight: 800;">BKK Lensa</a>
                        </div>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="copyright pull-right">
                            ...
                            </script><a href="http://www.smklenterabangsa.sch.id"> Software Engineering | SMK Lentera Bangsa</a>
                        </div>
                    </div>
                </footer>
            </div>
